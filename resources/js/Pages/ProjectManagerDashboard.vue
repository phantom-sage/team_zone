                    ...
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-200">
                                <td class="p-2">
                                    <div class="flex">
                                        <div class="text-gray-800 py-3 text-left whitespace-nowrap">{{ project_manager?.project?.name }}</div>
                                    </div>
                                </td>
                                <td class="p-2">
                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                <div class="grid grid-cols-4 gap-4 ">
                                                    <div class="col-span-6 sm:col-span-4">
                                                        ...
                                                        <select v-model="addTeamMemberForm.team_member_id" id="pmanager" name="team_member_id"
                                                            ...
                                                            <option v-for="legitimate_team_member in legitimate_team_members" :value="legitimate_team_member.id" :key="legitimate_team_member.id">
                                                                {{ legitimate_team_member.name }}
                                                            </option>
                                                            <span class="text-red-600 font-weight-bold" v-if="addTeamMemberForm.errors.team_member_id">{{ addTeamMemberForm.errors.team_member_id }}</span>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full">
                            ...
                            <tbody class="font-medium divide-y divide-gray-100 text-gray-600 text-sm">
                            <!-- Row1 -->
                            <tr class="border-b border-gray-200 hover:bg-gray-200" v-for="staff in project?.staff" :key="staff.id">
                                <td class="p-2">
                                    <div class="flex">
                                        <div class="text-gray-800 py-3 text-left whitespace-nowrap">{{ staff.name }}</div>
                                    </div>
                                </td>
                                <td class="p-2">
                                                ...
                                                <div class="grid grid-cols-4 gap-4 ">
                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="taskname"
                                                            ...
                                                            Name</label>
                                                        <input v-model="addNewTaskForm.name" type="text" name="name" id="taskname"
                                                               autocomplete="given-name"
                                                               class="mt-1 h-8 focus:outline-none block w-full shadow-sm sm:text-sm border-solid border-2 border-gray-300 rounded-md">
                                                        <span class="text-red-600 font-weight-bold" v-if="addNewTaskForm.errors.name">{{ addNewTaskForm.errors.name }}</span>
                                                    </div>
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="taskduration"
                                                               class="block text-sm font-medium text-gray-700">Task
                                                            Duration</label>
                                                        <input v-model="addNewTaskForm.duration" type="date" name="duration" id="taskduration"
                                                               autocomplete="given-name"
                                                               class="mt-1 h-8 focus:outline-none block w-full shadow-sm sm:text-sm border-solid border-2 border-gray-300 rounded-md">
                                                        <span class="text-red-600 font-weight-bold" v-if="addNewTaskForm.errors.duration">{{ addNewTaskForm.errors.duration }}</span>
                                                    </div>
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="taskdisc"
                                                               class="block text-sm font-medium text-gray-700">Task
                                                            Discription</label>
                                                        <input v-model="addNewTaskForm.description" type="text" name="description" id="taskdisc"
                                                               autocomplete="given-name"
                                                               class="mt-1 h-8 focus:outline-none block w-full shadow-sm sm:text-sm border-solid border-2 border-gray-300 rounded-md">
                                                        <span class="text-red-600 font-weight-bold" v-if="addNewTaskForm.errors.description">{{ addNewTaskForm.errors.description }}</span>
                                                    </div>

                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="taskStatus"
                                                               class="block text-sm font-medium text-gray-700">Task Status</label>
                                                        <input v-model="addNewTaskForm.status" type="text" name="status" id="taskStatus"
                                                               autocomplete="given-name"
                                                               class="mt-1 h-8 focus:outline-none block w-full shadow-sm sm:text-sm border-solid border-2 border-gray-300 rounded-md">
                                                        <span class="text-red-600 font-weight-bold" v-if="addNewTaskForm.errors.status">{{ addNewTaskForm.errors.status }}</span>
                                                    </div>

                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="tmember"
                                                               class="block text-sm font-medium text-gray-700">Members</label>
                                                        <select v-model="addNewTaskForm.team_member_id" id="tmember" name="team_member_id" autocomplete="pmanager-name"
                                                                class="mt-1 h-8 bg-white focus:outline-none block w-full shadow-sm sm:text-sm border-solid border-2 border-gray-300 rounded-md">
                                                            <option :key="legitimate_team_member_for_task_assignment.id" :value="legitimate_team_member_for_task_assignment.id" v-for="legitimate_team_member_for_task_assignment in legitimate_team_members_for_task_assignment">
                ...
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full">
                            ...
                            <tbody class="font-medium divide-y divide-gray-100 text-gray-600 text-sm">
                            <!-- Row1 -->
                            <tr class="border-b border-gray-200 hover:bg-gray-200" v-for="task in project_tasks" :key="task.id">
                                <td class="p-2">
                                    <div class="flex">
                                        <div class="text-gray-800 py-3 text-left whitespace-nowrap">{{ task.name }}</div>
                                    </div>
                                </td>
                                <td class="p-2">
...
export default {
    ...
    mounted() {
        console.log(this.legitimate_team_members)
    },
    data() {
        return {
            showModal: false,
